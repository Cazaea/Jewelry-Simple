...
public class HomeActivity extends BaseActivity {
    ...
    public void onLlVerifyNfcClicked() {
        Router.startActivity(HomeActivity.this, AppConfig.ROUTER_TOTAL_HEAD + "nfc");

    }

    @OnClick(R.id.ll_verify_scan)
    public void onLlVerifyScanClicked() {
        Router.startActivity(HomeActivity.this, AppConfig.ROUTER_TOTAL_HEAD + "scan");
    }

    @OnClick(R.id.ll_verify_input)
    public void onLlVerifyInputClicked() {
        Router.startActivity(HomeActivity.this, AppConfig.ROUTER_TOTAL_HEAD + "input");
    }
